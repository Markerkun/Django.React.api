                ...
                ">
                    ...
                    <Controller
                            ...
                            render={({ field, fieldState }) => (
                                <div>
                                    <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1.5">Ім'я</label>
                                    <input {...field} 
                                    placeholder="Frist naem"
                                    className={`
                        ...
                        <Controller
                            ...
                            render={({ field, fieldState }) => (
                                <div>
                                    <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1.5">Прізвище</label>
                                   <input
                                        type="lastname"
                                        {...field}
                       ...
                       <Controller
                        ...
                        <Controller
                            ...
                            render={({ field, fieldState }) => (
                                <div>
                                    <div className="flex items-center justify-between mb-1.5">
                                        <label className="block text-sm font-medium text-slate-700 dark:text-slate-300">Підтвердіть пароль</label>
                                    </div>
                        ...
                        <div className="flex items-center gap-2.5 pt-1">
                            <input
                                ...
                                type="checkbox"
                                className="
                                    w-4 h-4 rounded-md border-slate-300 dark:border-slate-600
                                    accent-indigo-500
                                    cursor-pointer
                                "
                            />
